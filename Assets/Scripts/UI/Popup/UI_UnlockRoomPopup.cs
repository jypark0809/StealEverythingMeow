...
public class UI_UnlockRoomPopup : UI_Base
{
    ...
    void CheckGoods()
    {
        if (Managers.Data.Spaces[1200 + Managers.Game.SaveData.SoomLevel + 1].Cotton == 0)
            Managers.Resource.Destroy(GetObject((int)GameObjects.ConSetCotton));
        else
        {
            if (Managers.Data.Spaces[1200 + Managers.Game.SaveData.SoomLevel + 1].Cotton > Managers.Game.SaveData.Cotton)
        ...
        if (Managers.Data.Spaces[1200 + Managers.Game.SaveData.SoomLevel + 1].Wood == 0)
            Managers.Resource.Destroy(GetObject((int)GameObjects.ConSetWood));
        else
        {
            if (Managers.Data.Spaces[1200 + Managers.Game.SaveData.SoomLevel + 1].Wood > Managers.Game.SaveData.Wood)
        ...
        if (Managers.Data.Spaces[1200 + Managers.Game.SaveData.SoomLevel + 1].Stone == 0)
            Managers.Resource.Destroy(GetObject((int)GameObjects.ConSetStone));
        else
        {
            if (Managers.Data.Spaces[1200 + Managers.Game.SaveData.SoomLevel + 1].Stone > Managers.Game.SaveData.Cotton)
